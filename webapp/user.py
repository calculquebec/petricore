...
class User:
    def __init__(self, username):
        ...
        self.__scratch_files["file_count"], self.__scratch_files["percentage"] = self.get_scratch_file_usage(self.__username)
    ...
    def retrieve_user_projects(self, username):
        ...
        dc_string = "dc={},dc={},dc={},dc={}".format(ldap_host[1], ldap_host[2], ldap_host[3], ldap_host[4])
